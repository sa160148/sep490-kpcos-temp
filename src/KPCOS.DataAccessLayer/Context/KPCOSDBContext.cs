...
public class KPCOSDBContext : DbContext
{
    private readonly string _hardConn1 = "Host=172.18.0.3;Port=5432;Database=kpcos;Username=postgre;Password=12345";
    private readonly string _hardConn2 = "Host=172.18.0.3;Port=5432;Database=kpcos;Username=postgre;Password=12345";
...
//     
    ...
    protected override void OnModelCreating(ModelBuilder builder)
        => builder.HasPostgresEnum<EnumService>();
